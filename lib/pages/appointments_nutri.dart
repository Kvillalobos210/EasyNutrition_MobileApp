...
class AppointmentNutri extends StatefulWidget {
  const AppointmentNutri({Key? key}) : super(key: key);

  @override
  State<AppointmentNutri> createState() => _AppointmentNutriState();
}

class _AppointmentNutriState extends State<AppointmentNutri> {
  @override
